...
[![GPA](https://img.shields.io/codeclimate/github/virtkick/virtkick-irc-bot.svg?style=flat-square)](https://codeclimate.com/github/virtkick/virtkick-irc-bot)
[![Build status](https://img.shields.io/travis/virtkick/virtkick-irc-bot.svg?style=flat-square)](https://travis-ci.org/virtkick/virtkick-irc-bot)
[![Dependencies status](http://img.shields.io/gemnasium/virtkick/virtkick-irc-bot.svg?style=flat-square)](https://gemnasium.com/virtkick/virtkick-irc-bot)
...
That's our IRC bot. It gets notifications from all over the place - GitHub, Twitter and so on.
